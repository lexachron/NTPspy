from storageprovider import BufferType, DiskStorageProvider, FatalStorageError, StorageError
import logging
import zlib
...
provider = DiskStorageProvider("./incoming")
...
for file in files:
    ...
    #provider.finalize_session(session_id, overwrite=True)
